...
+'			<a href="#" target="_blank" title="《游戏名字》" ><img src="images/bomlogo.png"></a>'
+'		</div>'
...
//公司统一的版权号
+'			<p>'
+'				<span class="SDGCOPYRIGHT-pr3">All rights reserved. 游戏名字  版权所有 本游戏由【游戏名字】开发运营 万元广告 千人同服</span>'
+'			</p>'
+'			<p class="SDGCOPYRIGHT-sdlogo">'
+'				<span class="SDGCOPYRIGHT-pr3">本网站设计及美工由<a href="http://www.8899ps.com/" target="_blank" title="8899ps工作室" >8899ps设计工作室</a>独家设计制作</span>'
+'			</p>'
+'		</div>'
//右侧网络警察3个图标
...
+'			<span>'
+'<a href="http://www.8899ps.com/" target="_blank" title="传奇高端网站设计制作"><img src="images/8899ps.png" border=0></a>'
+'			</span>'
+'		</div>'
